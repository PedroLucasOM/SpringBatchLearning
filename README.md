...
**Custom Processor:** His custom processor implements a Classifier to return to the [ClassifierCompositeItemProcessor](https://github.com/PedroLucasOM/SpringBatchLearning#classifiercompositeitemprocessor). It is responsible to make a HashMap with the [BankAccountType](https://github.com/PedroLucasOM/SpringBatchLearning/blob/master/src/main/java/com/springbatch/SpringBatchLearning/model/BankAccountType.java) and your respective processor. After it, it calls the returnFromSalaryRange() method of [BankAccountType](https://github.com/PedroLucasOM/SpringBatchLearning/blob/master/src/main/java/com/springbatch/SpringBatchLearning/model/BankAccountType.java) parsing the salaryRange and, according this range, return the respective [BankAccountType](). Finally, get in the HashMap previously configured the respective processor and run it to make the [BankAccount](https://github.com/PedroLucasOM/SpringBatchLearning/blob/master/src/main/java/com/springbatch/SpringBatchLearning/model/BankAccount.java). <br/>
